...
@interface HW3DBannerView ()<UIScrollViewDelegate>
/** 页码指示器 */
...
//    self.leftIV.contentMode = UIViewContentModeScaleAspectFill;
    ...
    img1.image = [UIImage imageNamed:@"新版首页banner阴影"];
     [self.mainScrollView addSubview:img1];
...
//    self.centerIV.contentMode = UIViewContentModeScaleAspectFill;
    ...
    img2.image = [UIImage imageNamed:@"新版首页banner阴影"];
    [self.mainScrollView addSubview:img2];
...
//    self.rightIV.contentMode = UIViewContentModeScaleAspectFill;
    ...
    img3.image = [UIImage imageNamed:@"新版首页banner阴影"];
    [self.mainScrollView addSubview:img3];
...
-(void)updateViewFrameSetting{
    ...
    img1.frame =CGRectMake(self.itemMargnPadding/2 + 16,  ZXMainScrollViewHeight-self.imageHeightPoor, self.imgWidth - 32, 17);
    //图片视图；中间
    self.centerIV.frame = CGRectMake(ZXMainScrollViewWidth + self.itemMargnPadding/2, 0.0, self.imgWidth, ZXMainScrollViewHeight);
    img2.frame =CGRectMake(ZXMainScrollViewWidth + self.itemMargnPadding/2+ 16,  ZXMainScrollViewHeight, self.imgWidth - 32, 17);
    //图片视图；右边
    ...
    img3.frame =CGRectMake(ZXMainScrollViewWidth * 2.0 + self.itemMargnPadding/2 + 16,  ZXMainScrollViewHeight-self.imageHeightPoor, self.imgWidth - 32, 17);
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView {
    if (self.itemMargnPadding > 0) {
        ...
        if (currentX > 0) { //左滑
            ...
            img2.y =self.centerIV.height+self.centerIV.y;
            ...
            self.rightIV.y = self.imageHeightPoor-currentX/ZXMainScrollViewWidth*self.imageHeightPoor;
             img3.y =self.rightIV.y+self.rightIV.height;
            ...
            self.leftIV.y = self.imageHeightPoor+currentX/ZXMainScrollViewWidth*self.imageHeightPoor;
             img1.y =self.leftIV.y +self.leftIV.height;
        } else {
            self.leftIV.alpha = self.initAlpha;
            self.centerIV.alpha = 1;
            self.rightIV.alpha = self.initAlpha;
