...
@interface CerSearchTitleView ()

@property (nonatomic, strong) UIView *sliderView;
@property (nonatomic, weak) UIButton *selectedButton;

@end
@implementation CerSearchTitleView
...
- (UIButton *)titleButton:(NSString *)title {
    ...
    titleButton.titleLabel.font = BoldFont(15);
    [titleButton setTitleColor:k46Color forState:UIControlStateNormal];
    [titleButton setTitleColor:k210Color forState:UIControlStateSelected];
...
- (UIView *)sliderView {
    if (!_sliderView) {
        ...
        sliderView.backgroundColor    = kOrangeColor;
